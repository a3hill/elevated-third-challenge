    ...
    <?php if ($top_bar): ?>
      ...
      <nav class="top-bar" data-topbar <?php print $top_bar_options; ?>>
        <ul class="title-area">
          <li>
            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
              <svg class="logo" viewBox="0 0 120 105">
                <use xlink:href="<?php print base_path(); ?><?php print path_to_theme(); ?>/imgs/imgs.svg#logo" />
              </svg>
            </a>
          </li>
        ...
        <?php if ($top_bar_secondary_menu) : ?>
          <section class="top-bar-section secondary">
    ...
    <?php if (!empty($page['footer_firstcolumn']) || !empty($page['footer_secondcolumn'])): ?>
      ...
      <section class="row l-footer-columns">
        <?php if (!empty($page['footer_firstcolumn'])): ?>
          <div class="footer-first medium-5 columns">
